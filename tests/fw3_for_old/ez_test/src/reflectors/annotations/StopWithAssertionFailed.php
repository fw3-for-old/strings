...
/**
 * Annotation: StopWithAssertionFailed
 *
 * 一つでもアサーションに失敗したら、以降のアサーションを行わない
 */
class StopWithAssertionFailed extends AbstractBoolAnnotation
{
    /**
     * @var string  アノテーション
     */
    const ANNOTATION    = '@stopWithAssertionFailed';
}
